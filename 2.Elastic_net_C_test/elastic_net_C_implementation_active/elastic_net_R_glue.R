...
dyn.load("elastic_net_C_implementation_active/ENCE_impute_active.so")
...
ence_impute_cycle_active <- function(df_old, missing_idx, folds, lambda_io, alpha_io, 
  ...
  .Call("ence_impute_cycle_active_R", df_mat, miss, fld,
