...
dyn.load("elastic_net_C_implementation_warm_start/ENCE_impute_warm.so")
...
ence_impute_cycle_warmstart <- function(df_old, missing_idx, folds, lambda_io, alpha_io, 
