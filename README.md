...
For a presentation of the code running, see: [Parallel-Chained-Equations](https://github.com/mclane2/Parallel-Chained-Equations). This repository contains code that runs a comparison between the original R version, the synchronous R version and C implementation of ENCE and MICE DURR on simulated data.
...
**`development_worklog/`**
This directory was my original working directory. It shows the development of the code over the course of the project.
