...
SEXP warmstart_ence_impute_cycle_R(SEXP df_old_sexp, SEXP missing_sexp, SEXP folds_sexp, SEXP lambdas_sexp, SEXP alphas_sexp,
                         SEXP nfolds_sexp, SEXP thresh_sexp, SEXP maxit_sexp, SEXP nthreads_sexp, SEXP lambda_io_sexp, SEXP alpha_io_sexp)
{
    ...
    ence_impute_cycle(REAL(df_old_sexp), REAL(df_new_sexp), INTEGER(missing_sexp), INTEGER(folds_sexp), n, p, REAL(lambdas_sexp), LENGTH(lambdas_sexp),
