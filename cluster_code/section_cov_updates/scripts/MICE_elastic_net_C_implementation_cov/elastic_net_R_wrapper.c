...
SEXP mice_impute_cycle_R_cov(SEXP df_old_sexp, SEXP missing_sexp, SEXP folds_sexp, SEXP lambdas_sexp, SEXP alphas_sexp,
                         ...
                         SEXP noise_sexp, SEXP boot_sexp)
{
    ...
    int failed = mice_impute_cycle(REAL(df_old_sexp), REAL(df_new_sexp), INTEGER(missing_sexp), INTEGER(folds_sexp), n, p,
